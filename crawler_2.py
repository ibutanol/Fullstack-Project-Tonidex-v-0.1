...
def crawl():
    time.sleep(1)
    # you need everytime you run this code a new key from tonie.de
    url = "https://tonies.com/_next/data/P9a9GXYGfSs6dFPQYRNNq/de-de/tonies.json?locale=de-de&slug=tonies&page=99"
